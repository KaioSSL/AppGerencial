...
CREATE TABLE IF NOT EXISTS `AppGerencial`.`FIN_BUY` (
  `BUY_COD` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `AppGerencial`.`INS_AMZ` (
  `INS_AMZ_COD` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `AppGerencial`.`BUY_INS` (
  `BUY_INS_COD` INT NOT NULL AUTO_INCREMENT,
  `INS_COD` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `AppGerencial`.`PRD_INS` (
  `PRD_INS_COD` INT NOT NULL AUTO_INCREMENT,
  `PRD_INS_DAT_CAD` DATETIME NOT NULL,
  `INS_COD` INT NOT NULL,
  `PRD_COD` INT NOT NULL,
  `INS_QTD` DOUBLE NOT NULL,
...
CREATE TABLE IF NOT EXISTS `AppGerencial`.`FIN_SELL` (
  `SELL_COD` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `AppGerencial`.`PRD_AMZ` (
  `PRD_AMZ_COD` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `AppGerencial`.`SELL_PRD` (
  `SELL_PRD_COD` INT NOT NULL AUTO_INCREMENT,
  `PRD_COD` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `AppGerencial`.`USER`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `AppGerencial`.`USER` (
...
INSERT INTO USER(LOGIN,PASSWORD,ROLE,LAST_LOGIN,DAT_CAD) VALUES('ADM','ADM',1,CURRENT_DATE,CURRENT_DATE);